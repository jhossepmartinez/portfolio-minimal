export default function MdxLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="mx-auto w-full max-w-3xl mt-40 mb-80">
      <div
        className={`
          prose max-w-none 
          prose-headings:font-normal prose-headings:text-gray-12 prose-headings:text-base 
          prose-p:text-gray-11 
          prose-strong:text-gray-12 prose-strong:font-semibold 
          prose-ul:text-gray-11 prose-ol:text-gray-11 
